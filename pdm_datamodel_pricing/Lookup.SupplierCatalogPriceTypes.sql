...
UPDATE [ps].[Lookup.SupplierCatalogPriceTypes]
   SET [:Id] = <:Id, uniqueidentifier,>
      ...
      ,[PriceTypeNo] = <PriceTypeNo, nvarchar(30),>
      ,[PriceTypeAssignment:Link] = <PriceTypeAssignment:Link, nvarchar(30),>
      ,[SupplierCatalogPriceTypeAssignment:Link] = <SupplierCatalogPriceTypeAssignment:Link, nvarchar(30),>
