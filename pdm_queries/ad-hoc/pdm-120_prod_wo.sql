/*
  DEPRECATED: Obtain the number of products for electric vehicles in TecDoc and in the PDM that do not have a K24-Nr
*/
SELECT DISTINCT
...
WHERE
  ...
  -- Get articles that do not have a K24-Nr
  AND
