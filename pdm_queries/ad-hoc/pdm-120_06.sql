/*
   Get all articles in TecDoc and then obtain the relevant attributes
*/
SELECT TOP (100)
...
-- td_t2.[BodyType:Link],
  ...
  td_t4.[Name],
  td_t5.[ModelNo],
  td_t5.[Manufacturer:Link],
  td_t6.[ManufacturerNo],
  td_t6.[Name],
  td_t8.[GenericArticleNo],
--  td_t8.[StandardDesignation:Link],
  td_t9.[Designation],
  td_t11.[Designation]
